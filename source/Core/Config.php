...
const CONF_URL_BASE = "http://localhost/tastytales/"; // URL base do site, geralmente localhost em desenvolvimento
...
const CONF_DB_NAME = "tastytales"; // Nome do banco de dados
const CONF_DB_USER = "root"; // Usuário do banco de dados
const CONF_DB_PASS = "MariPanas26!"; // Senha do banco de dados, geralmente vazia em ambientes de desenvolvimento
